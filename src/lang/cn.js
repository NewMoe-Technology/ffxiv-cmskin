const Splash = {
  changelog: [
    '|2025.04.19|v2.3.10|Fix 会将其他玩家的陆行鸟统计进来造成无限重复的问题. 在数据未发生变化时(如观看过场动画, 被限制行动等)暂停图表更新. Aetheris主题调整.|',
    ...
    '|2024.03.30|v2.3.4|Add Aetheris 主题, 微调其他主题的样式|',
    ...
    '|2017.10.24|v1.0.8|Add 隐藏ID功能/Up 优化迷你模式|',
